  ...
  const subTopics = [
    {
      ...
      details: {
        ...
        summaryText: "고객님, 인터넷에 정보는 많지만 정작 고객님께 필요한 '진짜 회복 정보'는 찾기 힘드셨죠? 유니클은 그 안개 같은 정보의 장벽을 허물고, 과정을 숫자로 투명하게 보여드릴게요."
      }
    },
    {
      id: 'post-care-gap',
      ...
      details: {
        ...
        summaryText: "고객님, 시술보다 더 중요한 건 '시술 후의 90일'입니다. 병원이 챙기지 못하는 그 외로운 회복의 시간을 유니클이 24시간 함께하며, 불안함 없이 완벽하게 일상으로 돌아가도록 지켜드릴게요."
      }
    },
    {
      id: 'unpredictability',
      ...
      details: {
        ...
        summaryText: "고객님, 시술 후의 시간이 깜깜한 터널처럼 느껴지시죠? 유니클은 고객님의 회복 과정을 숫자로 미리 보여드리는 '회복 예측표'를 제공하여 불안함 없는 일상을 계획하게 도와드릴게요."
      }
    },
    {
      ...
      details: {
        ...
        points: [
          ...
          },
          {
            ...
            items: [
              "무리한 기대 방지: 회복 기간과 맞지 않는 무리한 시술 요청을 유니클이 미리 조절합니다.",
    ...
    },
    {
      ...
      details: {
        ...
        intro: "손님들은 시술을 받기 전 '내일 회사를 갈 수 있을까?', '언제쯤 얼굴이 예뻐질까?' 하고 앞날을 아주 궁금해합니다. 유니클은 단순히 '금방 나아요'라고 말하지 않고, 숫자와 표로 정확한 미래를 보여줍니다.",
        points: [
          {
        ...
        summaryText: "손님, 가격표보다 중요한 것은 고객님의 소중한 일상입니다. 유니클은 고객님이 언제 다시 웃으며 출근할 수 있는지 숫자로 먼저 약속드립니다."
      }
    },
    {
      ...
      details: {
        ...
        intro: "시술 후 딱 3일(72시간)은 우리 몸이 \"어라? 나 지금 변하고 있나 봐!\"라며 깜짝 놀라는 시간입니다. 이때 유니클이 어떻게 손님을 지켜주는지 4가지 마법으로 정리했습니다.",
        points: [
          {
            ...
            items: [
              ...
              "데이터 기반 판단: 주관적인 느낌이 아닌, 유사 데이터 비교를 통해 객관적인 상태를 진단합니다."
            ],
            icon: Activity
          },
          {
            ...
            items: [
              ...
              "빨강(🔴): 집중 케어. 병원 연계 및 즉각적인 조치를 유니클이 직접 돕습니다."
            ],
            icon: Zap
          },
          {
          ...
          },
          {
            ...
            items: [
              "소통의 장벽 제거: 병원에 묻기 미미한 사소한 질문들을 유니클이 먼저 파악해 해결합니다.",
              "책임의 확장: 시술은 병원이, 회복은 유니클이 끝까지 책임진다는 강력한 신뢰 관계를 형성합니다.",
              "최상의 결과 보장: 시술 후 72시간의 골든타임을 완벽히 관리하여 부작용을 원천 차단합니다."
            ],
            icon: HeartHandshake
          }
        ],
        summaryText: "고객님, 시술 직후 3일이 가장 무서우시죠? 유니클의 '72시간 밀착케어'는 고객님의 통증과 붓기를 24시간 감시합니다. 우리 몸의 신호등을 초록색으로 유지할 수 있게, 유니클이 당신의 곁을 지키겠습니다."
      }
    }
  ];
        ...
        points: [
          ...
          },
          {
            ...
            items: [
              ...
              "유니클은 시술 직후 가장 떨리는 72시간 동안 유니클 전문가가 24시간 내내 곁에서 상태를 확인해 줍니다.",
          ...
          },
          {
            ...
            items: [
              ...
              "유니클은 병원 밖의 수면, 식사, 휴식 등을 운영 시스템(OS)처럼 모두 관리해 줍니다.",
              "한 번의 시술로 끝나는 게 아니라, 계속해서 건강해지는 과정을 관리받는 지속 가능한 플랫폼을 제공합니다."
            ],
            icon: RefreshCw
          }
        ],
        summaryText: "손님, 시술을 받는 건 시작일 뿐입니다. 진짜 가치는 '누가 당신의 회복을 끝까지 설계하고 보호하는가'에 있습니다. 유니클은 당신에게 불안이 없는 완벽한 회복의 통제권을 드립니다."
      }
    },
    {
      id: 'our-secret',
        ...
        points: [
          ...
          },
          {
            ...
            items: [
              ...
              "불안 제거 프로세스: 유니클이 녹색/황색/적색으로 즉시 상태를 판별해 안심을 선사합니다.",
          ...
          },
          {
            ...
            items: [
              ...
              "새로운 수익 정산: '회복 멤버십' 등 유니클이 새로 창출한 수익만 나누는 구조입니다.",
