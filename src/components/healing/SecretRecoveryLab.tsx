                        ...
                        {formStep === 3 && (
                            ...
                            >
                                ...
                                <div className="flex gap-3 md:gap-4">
                                    ...
                                    <Button className="h-14 sm:h-16 flex-[2] bg-[#D4AF37] text-black rounded-[16px] sm:rounded-[20px] font-black text-xs sm:text-sm uppercase tracking-widest justify-center" onClick={handleSubmitForm}>유니클 정밀 분석 시작</Button>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
