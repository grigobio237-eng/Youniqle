        ...
        <div className="space-y-4">
          ...
          {attentionPlayers.length > 0 ? (
            ...
            <div className="p-8 text-center border border-dashed border-line/20 rounded-2xl">
              ...
              <p className="text-sm font-bold text-slate/50">오늘 주의해야 할 선수가 없습니다.</p>
              <p className="text-xs text-slate/40 mt-1">모든 선수가 정상적인 훈련 부하를 감당할 수 있습니다.</p>
            </div>
          )}
        </div>
      </CardContent>
