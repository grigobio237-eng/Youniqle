...
export default function GoogleAddressSearch({ onAddressSelect, disabled = false }: GoogleAddressSearchProps) {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/google/address', {
        method: 'POST',
        headers: {
    ...
    <div className="space-y-2">
      <div className="flex gap-2">
        <Input
          ...
          placeholder="주소를 검색하세요 (예: 명일동, 강남구, Seoul, Tokyo)"
