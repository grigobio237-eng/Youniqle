...
export default function CommunityBoard({ onPostSelect, onPostCreate }: CommunityBoardProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          <Button 
            ...
            className="h-12 px-6 rounded-2xl bg-chapter-accent text-white font-black flex items-center gap-2 hover:scale-[1.02] transition-transform shrink-0 shadow-lg shadow-chapter-accent/20"
          >
            <Plus className="w-5 h-5" /> 소통하기
          </Button>
        </div>
      </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-sm font-bold text-slate/60 uppercase tracking-widest">Loading Lounge Content...</p>
        </div>
