...
export const ABOUT_CONTENT: AboutContent = {
  ...
  founderPass: {
    essence: "ESSENCE (39만원): 디지털 회복 루틴 스타터",
    balance: "BALANCE (69만원): 전문가 지식 및 데이터 시각화",
    miracle: "MIRACLE (99만원): AI 웹툰 및 데이터 자산화 프리엄"
  },
  standard: [
    ...
    "AI 내비게이터와 AI 웹툰 제네레이터가 당신의 회복 데이터를 매일 분석하고 자산화합니다.",
