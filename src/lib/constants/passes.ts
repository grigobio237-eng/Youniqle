...
export const PASS_SPECS: Record<string, any> = {
  ...
  black: {
    ...
    keyBenefits: [
      ...
      {
        id: 5,
        title: '유니클 독점 프로그램 평생 이용권',
        desc: '블랙 멤버십 회원에 한해 유니클이 제공하는 프리미엄 회복 솔루션 프로그램에 대한 평생 이용 권한이 부여됩니다.',
        navigatorNote: '운영 팁: 블랙 멤버십 전용 프로그램 운영 및 파트너사 비용 운영 최적화 방안에 대해 안내하세요. (상담 시 별도 제공되는 오프라인 운영 매뉴얼의 상세 가이드를 반드시 준수해 주시기 바랍니다.)'
      }
    ],
    careServices: [
