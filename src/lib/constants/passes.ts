...
export const PASS_SPECS: Record<string, any> = {
  ...
  black: {
    id: 'black',
    name: 'BLACK PASS',
    title: '[BLACK] 단 한 명을 위한 하이엔드 회복 컨시어지',
    subtitle: '"완벽한 프라이버시 속에서 이루어지는 최고의 경험"',
    intro: '비공개 상담과 전문 기관 연계, 1:1 밀착 관리를 지원하는 최상위 등급입니다. 모든 과정은 극도로 프라이빗하게 진행됩니다.',
    price: '별도 문의',
    period: '개별',
    position: '1:1 밀착 케어 및 비공개 전문 동행 서비스',
    recommendations: [
      '절대적인 보안 속에서 집중적인 회복 케어가 필요하신 분',
      '복잡한 예약과 조율 대신 최우선권과 편의가 중요하신 분',
      '전문 기관 방문 시 신뢰할 수 있는 전문가의 동행을 원하시는 분'
    ],
    keyBenefits: [
      { id: 1, title: 'VVIP 전담 프라이빗 상담', desc: '언제든 전담 상담사와 직접 소통할 수 있는 전용 핫라인을 제공합니다.' },
      { id: 2, title: '최상위 조용한 정리 & 가이드', desc: '모든 데이터를 실시간으로 검토하여 즉각적인 가이드라인을 제시합니다.' },
      { id: 3, title: '전문 기관 동행 (요청 시)', desc: '필요 시 유니클 전문가가 직접 동행하여 최적의 회복 과정을 지원합니다.' }
    ],
