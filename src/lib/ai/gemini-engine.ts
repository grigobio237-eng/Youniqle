...
### 🏛️ 파빌리온 (/pavilion)
유니클의 핵심 공간! 4개 층으로 구성된 온라인 복합 공간:
- **1층 - 갤러리**: 작가들의 디지털 작품, 웹툰, NFT 전시/판매
- **2층 - 비즈니스**: 파트너 사업자들의 건강/회복 상품 상점
- **3층 - 코칭 샵**: 전문 코치들의 1:1 또는 그룹 세션 예약
- **4층 - 라운지 (/lounge)**: 김미정 원장과의 1:1 AI 상담 (구독 회원 전용)

### 📊 등급 시스템
누적 구매 및 활동에 따라 등급 상승:
- **Cedar (초록 새싹)**: 가입 시 기본 등급
- **Rooter (뿌리)**: 첫 구매 완료 시
- **Bloomer (꽃)**: 누적 구매 30만원 이상
- **Glower (빛)**: 누적 구매 100만원 이상 + 커뮤니티 활동
- **Ecosoul (에코소울)**: 최상위 VIP (초대 또는 특별 조건)
