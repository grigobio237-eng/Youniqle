...
import { Sparkles, Image as ImageIcon, Dna } from 'lucide-react';
            ...
            <div className="py-6">
                <Tabs defaultValue="detail" className="w-full">
                    <div className="flex justify-center mb-8">
                        <TabsList className="grid w-full max-w-xl grid-cols-3 bg-slate-100 p-1">
                            <TabsTrigger value="detail" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">
                                <Sparkles className="h-4 w-4 mr-2 text-blue-500" />
                                상세페이지 빌더
                            </TabsTrigger>
                            <TabsTrigger value="pavilion" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">
                    ...
                    <TabsContent value="pavilion" className="mt-0 focus-visible:outline-none">
