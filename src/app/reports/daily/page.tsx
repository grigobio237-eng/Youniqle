        ...
        <main className="min-h-screen bg-mist/30 pb-20">
            ...
            <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-line px-6 py-4">
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                    ...
                    <h1 className="font-black text-lg text-obsidian tracking-tight">60초 리듬체크 히스토리</h1>
            ...
            <div className="max-w-4xl mx-auto px-6 py-10 space-y-12">
                ...
                <section className="space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-obsidian tracking-tight italic">회복 흐름 분석</h2>
                            <p className="text-sm text-slate font-medium">당신의 컨디션 변화 추이를 확인하세요.</p>
                        </div>
                    </div>

                    {/* Chart Card */}
                    <Card className="bg-white border-line rounded-[32px] overflow-hidden shadow-xl shadow-obsidian/5">
                        <CardContent className="p-8">
                            <div className="flex justify-end mb-6">
                                <div className="inline-flex bg-mist/50 p-1 rounded-xl border border-line/50">
                                    {[
                                        { id: '1D', label: '일' },
                                        { id: '1M', label: '월' },
                                        { id: '1Y', label: '년' }
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-1.5 rounded-lg text-[10px] font-black transition-all ${
                                                period === p.id 
                                                ? 'bg-obsidian text-primary shadow-lg' 
                            ...
                            {loading ? (
                                ...
                                <div className="h-64 flex flex-col items-center justify-center text-center space-y-4">
                                    <p className="text-slate font-medium">아직 기록된 회복 데이터가 없습니다.</p>
                ...
                <section className="space-y-4">
                    ...
                    <Card className="bg-obsidian text-white rounded-[32px] overflow-hidden shadow-2xl relative">
                        ...
                        <CardContent className="p-8 md:p-10 relative z-10 space-y-6">
                            {insightLoading ? (
                                ...
                                <div className="prose prose-invert max-w-none text-mist/80 text-sm md:text-base leading-relaxed font-medium">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start justify-between gap-4">
                                            <h4 className="text-2xl md:text-3xl font-black text-white leading-tight tracking-tighter">
                                                "{insight.insight.headline}"
                                            </h4>
                                            {insight.insight.statusBadge && (
                                                <Badge className={`shrink-0 px-3 py-1 rounded-full font-black text-[10px] tracking-widest ${
                                        ...
                                        <p className="text-mist/70 text-sm md:text-base leading-relaxed font-medium">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                                        ...
                                        {insight.insight.radarData && (
                                            <div className="h-64 w-full bg-white/5 rounded-3xl p-4 flex items-center justify-center">
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <RadarChart cx="50%" cy="50%" outerRadius="80%" data={insight.insight.radarData}>
                                        ...
                                        {/* Missions */}
                                        <div className="space-y-4">
                                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">Next Actions</p>
                                            {insight.insight.missions?.map((m: any, i: number) => (
                                                <div key={i} className="bg-white/10 border border-white/10 p-4 rounded-2xl flex items-center gap-4 group hover:bg-white/20 transition-all">
                                                    <div className="w-10 h-10 shrink-0 bg-primary/20 rounded-full flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                                                        <Sparkles className="w-5 h-5" />
                                                    </div>
                                                    <div>
                                                        <p className="text-[9px] font-black text-primary/60 uppercase tracking-widest">{m.category}</p>
                                                        <h5 className="text-sm font-bold text-white mb-0.5">{m.title}</h5>
                                                        <p className="text-[10px] text-mist/40 font-medium">{m.effect} • {m.reward}</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    {insight.insight.detailedAnalysis && (
                                        <div className="pt-6 border-t border-white/10">
                                            <button 
                                                ...
                                                className={`w-full flex items-center justify-between p-6 rounded-[28px] transition-all duration-500 group border-2 ${
                                                    isAnalysisExpanded 
                                            ...
                                            >
                                                <div className="flex items-center gap-5">
                                                    <div className={`w-14 h-14 shrink-0 rounded-2xl flex items-center justify-center transition-all duration-500 overflow-hidden shadow-inner ${
                                                        isAnalysisExpanded ? 'bg-obsidian/10' : 'bg-primary'
                                                    }`}>
                                                        <img 
                                                            src="/images/characters/char_diagnosis.png" 
                                                            alt="Youniqle Analysis Character" 
                                                            className="w-11 h-11 object-contain transform group-hover:scale-110 transition-transform duration-500"
                                                        />
                                                    </div>
                                                    <div className="text-left">
                                                        <span className={`block text-lg font-black tracking-tight transition-colors duration-500 ${
                                            ...
                                            <AnimatePresence>
                                                {isAnalysisExpanded && (
                                                    ...
                                                    >
                                                        <div className="mt-6 p-6 rounded-3xl bg-white/5 border border-white/5 prose prose-invert prose-sm max-w-none text-mist/60 leading-relaxed font-medium">
                                ...
                                <p className="text-mist/50 italic text-sm">데이터 분석을 기다리고 있습니다...</p>
                            )}
                            
                            <div className="pt-4 border-t border-white/10 flex items-center gap-2 text-[10px] font-black text-primary uppercase tracking-widest">
                                ...
                                >
                                    <CardContent className="p-5 flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-mist rounded-xl flex flex-col items-center justify-center">
                                                <span className="text-[10px] font-black text-slate leading-none">
                                                    {new Date(d.createdAt).toLocaleString('ko-KR', { month: 'short' })}
                                                </span>
                                                <span className="text-lg font-black text-obsidian leading-none mt-1">
                                                    {new Date(d.createdAt).getDate()}
                                                </span>
                                            </div>
                                            <div>
                                                <h4 className="font-black text-obsidian tracking-tight">{getDiagnosisTitle(d)}</h4>
                                                <div className="flex items-center gap-2 mt-1">
                                                    <Badge className="bg-mist text-slate border-none text-[9px] font-bold px-2 py-0">
                                        ...
                                        <div className="flex items-center gap-6">
                                            <div className="text-right">
                                                <span className="block text-[10px] font-black text-slate/40 uppercase tracking-widest leading-none">Score</span>
                                                <span className="text-xl font-black text-obsidian leading-none">{d.totalScore}</span>
                                            </div>
                                            <ChevronRight className="w-5 h-5 text-line group-hover:text-primary transition-colors" />
                                        </div>
                                    </CardContent>
                                </Card>
                            </motion.div>
                        )) : (
                            <div className="text-center py-10 text-slate font-medium text-sm">기록된 타임라인이 없습니다.</div>
                        )}
                    </div>
                </section>
            </div>
            ...
            <Dialog open={!!selectedDiagnosis} onOpenChange={() => setSelectedDiagnosis(null)}>
                <DialogContent className="max-w-2xl bg-white rounded-[32px] p-8 max-h-[85vh] overflow-y-auto">
                    <DialogHeader className="mb-6">
                        <DialogTitle className="text-2xl font-black text-obsidian flex items-center gap-2 italic">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                {Object.entries(selectedDiagnosis.categoryScores || {}).map(([key, val]: any) => (
                                    <div key={key} className="bg-mist/50 p-4 rounded-2xl text-center">
                                        <span className="text-[10px] font-black text-slate/60 uppercase tracking-widest block mb-1">{key}</span>
                                        <span className="text-lg font-black text-obsidian">{val}</span>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    {selectedDiagnosis.answers?.map((item: any, idx: number) => {
                                        ...
                                        return (
                                            <div key={idx} className="bg-mist/30 p-4 rounded-2xl border border-line/50">
                                                <p className="text-[10px] font-black text-chapter-accent uppercase tracking-widest mb-1">{resolvedCategory}</p>
                                                <p className="text-sm font-bold text-obsidian leading-snug mb-2">{resolvedQuestion}</p>
                                                <div className="flex items-center justify-between">
                                                    <Badge className="bg-obsidian text-white border-none text-[10px] font-black px-3 py-1">
                                                        {item.answer}
                                                    </Badge>
                                                    <span className="text-[10px] font-black text-slate/40 tracking-tighter">
                                                        영향도: {item.score}pt
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div className="bg-primary/10 border border-primary/20 p-6 rounded-[24px]">
                                <h4 className="font-black text-obsidian text-sm mb-2 flex items-center gap-2">
                                    <Sparkles className="w-4 h-4" />
                                    코치 한마디
                                </h4>
                                <p className="text-sm font-medium text-obsidian/80 leading-relaxed italic">
