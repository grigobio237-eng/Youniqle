...
export default function LoungePage() {
    ...
    return (
        <ChapterWrapper chapter="lounge" className="container mx-auto px-4 py-12">
            {/* 1. Profile Section */}
            <section className="mb-20">
                <div className="flex flex-col md:flex-row gap-12 items-center bg-surface p-8 md:p-12 rounded-3xl border border-line shadow-2xl">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <Badge variant="outline" className="mb-4 px-4 py-1 badge-primary">Representative Director</Badge>
