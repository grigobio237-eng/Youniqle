...
const utilities: UtilityCard[] = [
    {
        ...
        icon: <img src="/images/characters/char_scanner.png" alt="스캐너" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복', '이미지'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_diagnosis.png" alt="진단" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복'],
        href: '/utils/mbti',
        badge: 'Youniqle CORE',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_posture.png" alt="자세분석" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복', '이미지'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_sound.png" alt="사운드테라피" className="w-14 h-14 object-contain" />,
        category: ['회복', '건강'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_sleep.png" alt="나이트리커버리" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_breathing.png" alt="호흡" className="w-14 h-14 object-contain" />,
        category: ['건강', '생산성'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_water.png" alt="수분체크" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_stretch.png" alt="스트레칭" className="w-14 h-14 object-contain" />,
        category: ['건강', '생산성'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_bmi.png" alt="BMI" className="w-14 h-14 object-contain" />,
        category: ['계산', '건강'],
        href: '/utils/bmi',
        badge: 'PROTO',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_removebg.png" alt="배경제거" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_memo.png" alt="메모장" className="w-14 h-14 object-contain" />,
        category: ['생산성'],
        href: '/utils/memo',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_todo.png" alt="할일관리" className="w-14 h-14 object-contain" />,
        category: ['생산성'],
        href: '/utils/todo',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_currency.png" alt="환율계산기" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/currency',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_qr.png" alt="QR코드생성" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
        href: '/utils/qr',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_dday.png" alt="D-Day계산" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/dday',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_unit.png" alt="단위변환기" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/unit',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_compress.png" alt="이미지최적화" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
        href: '/utils/compress',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <img src="/images/characters/char_weather.png" alt="날씨정보" className="w-14 h-14 object-contain" />,
        category: ['검색'],
        href: '/utils/weather',
        badge: 'FREE',
