...
const utilities: UtilityCard[] = [
    {
        ...
        description: '공간의 분위기와 식단의 영양을 한 번에 스캔하여 현재의 회복 상태를 분석합니다.',
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_scanner.png" alt="스캐너" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복', '이미지'],
    ...
    },
    {
        ...
        description: '한 장의 사진으로 거북목과 회복 자세를 유니클이 분석하여 고품격 교정 가이드를 드립니다.',
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_posture.png" alt="자세분석" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복', '이미지'],
    ...
    },
    {
        ...
        description: '회복 주파수와 사운드스케이프를 통해 깊은 이완과 명상의 시간을 제공합니다.',
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_sound.png" alt="사운드테라피" className="w-14 h-14 object-contain" />,
        category: ['회복', '건강'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_sleep.png" alt="나이트리커버리" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_breathing.png" alt="호흡" className="w-14 h-14 object-contain" />,
        category: ['건강', '생산성'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_water.png" alt="수분체크" className="w-14 h-14 object-contain" />,
        category: ['건강', '회복'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_stretch.png" alt="스트레칭" className="w-14 h-14 object-contain" />,
        category: ['건강', '생산성'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_bmi.png" alt="BMI" className="w-14 h-14 object-contain" />,
        category: ['계산', '건강'],
        href: '/utils/bmi',
        badge: 'PROTO',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_removebg.png" alt="배경제거" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_memo.png" alt="메모장" className="w-14 h-14 object-contain" />,
        category: ['생산성'],
        href: '/utils/memo',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_todo.png" alt="할일관리" className="w-14 h-14 object-contain" />,
        category: ['생산성'],
        href: '/utils/todo',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_currency.png" alt="환율계산기" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/currency',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_qr.png" alt="QR코드생성" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
        href: '/utils/qr',
        badge: 'HOT',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_dday.png" alt="D-Day계산" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/dday',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_unit.png" alt="단위변환기" className="w-14 h-14 object-contain" />,
        category: ['계산'],
        href: '/utils/unit',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_compress.png" alt="이미지최적화" className="w-14 h-14 object-contain" />,
        category: ['이미지'],
        href: '/utils/compress',
        badge: 'FREE',
    ...
    },
    {
        ...
        icon: <Image width={800} height={800} style={{ width: '100%', height: '100%', objectFit: 'inherit' }} unoptimized src="/images/characters/char_weather.png" alt="날씨정보" className="w-14 h-14 object-contain" />,
        category: ['검색'],
        href: '/utils/weather',
        badge: 'FREE',
