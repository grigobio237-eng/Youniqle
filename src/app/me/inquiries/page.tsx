                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        <Button
                            ...
                            className="p-0 hover:bg-transparent text-slate-400 mb-2 font-bold text-xs uppercase tracking-widest"
                        >
                            ...
                            {inquiries.map((inquiry, idx) => (
                                ...
                                >
                                    <div
                                        ...
                                        className="group bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm hover:shadow-md hover:border-rose-100 transition-all cursor-pointer relative overflow-hidden"
                                    >
                                        <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between">
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <Badge variant="outline" className="bg-slate-50 text-slate-500 border-slate-200 text-[10px] px-2 py-0.5 font-bold">
                                                ...
                                                <h3 className="text-lg font-bold text-slate-800 group-hover:text-rose-600 transition-colors line-clamp-1">
                                                    {inquiry.subject}
                                                </h3>
                            ...
                            <>
                                <div className="p-8 border-b border-slate-100 bg-slate-50/50">
                                    <div className="flex items-center gap-3 mb-4">
                                        <Badge variant="outline" className="bg-white text-slate-500 border-slate-200 text-xs py-1">
                                ...
                                <div className="p-8 space-y-8">
                                    <div className="space-y-3">
                                        <h5 className="text-xs font-black text-slate-400 uppercase tracking-widest">Inquiry Content</h5>
                                        <div className="bg-slate-50 p-6 rounded-2xl text-sm leading-relaxed text-slate-700 whitespace-pre-wrap">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-3">
                                                {selectedInquiry.attachments.map((file, i) => (
                                                    <a
                                                        ...
                                                        className="flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-600 hover:border-rose-200 hover:text-rose-600 transition-colors"
                                                    >
                                    ...
                                    {selectedInquiry.adminAnswer ? (
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h5 className="text-xs font-black text-emerald-600 uppercase tracking-widest">Admin Response</h5>
                                            </div>
                                            <div className="bg-emerald-50/50 border border-emerald-100 p-6 rounded-2xl text-sm leading-relaxed text-slate-800 whitespace-pre-wrap shadow-sm">
                                                {selectedInquiry.adminAnswer}
                                            </div>
                                ...
                                <div className="p-6 pt-0 border-t-0 flex justify-end">
                                    <Button variant="ghost" onClick={() => setIsDetailOpen(false)} className="text-slate-400 hover:text-slate-600">
                                        닫기
                                    </Button>
                                </div>
                            </>
