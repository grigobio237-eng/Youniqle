...
import { PLAN_CONFIG } from '@/models/FootballSubscription';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const productName = `축구 플랫폼 ${planConfig.label} 플랜 구독`;
        ...
        const returnUrl = `${baseUrl}/api/football/subscription/payment/result`;
        ...
        console.error('Football Subscription Payment Request Error:', error);
        return NextResponse.json(
