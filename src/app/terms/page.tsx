            ...
            <div className="bg-white rounded-lg shadow-sm border p-8">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제1조 목적</h2>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제2조 정의</h2>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제3조 약관의 게시 및 개정</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제4조 이용계약의 성립</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제5조 계정의 관리</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제6조 서비스의 내용 및 범위</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                      ...
                      <li>회사가 제공하는 정보, 리포트, 안내, 상담 지원은 일반적 정보 제공을 위한 것이며, 의료행위, 의학적 리듬체크, 처방, 치료 지시 또는 의료광고에 해당하지 않습니다.</li>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제7조 결제 및 전자적 제공</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제8조 청약철회, 해지 및 환불</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제9조 포인트</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제10조 금지행위</h2>
                    <p className="text-obsidian leading-relaxed mb-2">회원은 다음 각 호의 행위를 하여서는 안 됩니다.</p>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제11조 회원의 의무</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제12조 회사의 의무</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제13조 서비스 변경 및 중단</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제14조 지식재산권</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제15조 면책</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제16조 계약 해지 및 이용 제한</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제17조 분쟁 해결 및 관할</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-obsidian mb-4">제18조 비의료 고지</h2>
                    <ol className="list-decimal pl-5 space-y-2 text-obsidian leading-relaxed">
                      <li>회사는 의료기관이 아니며, 의료행위를 수행하지 않습니다.</li>
                      <li>회사가 제공하는 리포트, 안내, 콘텐츠, 상담지원은 건강 및 생활관리에 관한 일반적 정보 제공을 목적으로 하며, 의료적 판단을 대체하지 않습니다.</li>
                      <li>의료적 리듬체크, 치료, 처방, 시술 여부 및 적합성은 반드시 의료기관 및 의료전문인력과 직접 상담하여 결정하여야 합니다.</li>
                    </ol>
                  </div>
                </div>
              </div>
