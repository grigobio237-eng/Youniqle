...
import { 
    ...
    Sparkles, Heart, Zap, Shield, HelpCircle 
} from 'lucide-react';
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <p className="text-slate/60 font-medium text-lg leading-relaxed">
                    응답해주신 내용을 바탕으로 {shopName}과 유니클 분석팀이 고객님께 가장 필요한 관리 방향과 맞춤 상품을 설계 중입니다.
                </p>
            </div>
            <div className="p-8 bg-mist rounded-[40px] border border-line space-y-6">
                <div className="space-y-2">
                    <p className="text-obsidian font-black">나의 분석 리포트 보관하기</p>
                    <p className="text-sm text-slate/50">가입 후 기록을 저장하시면 맞춤 제안과 전후 관리 안내를 가장 먼저 받아보실 수 있습니다.</p>
                </div>
                <Button 
                    onClick={() => router.push('/auth/signup')}
                    className="w-full h-16 bg-obsidian text-white rounded-2xl font-black text-lg"
                >
                    유니클에 리포트 저장하기
                </Button>
            </div>
      ...
      <div className="container max-w-xl px-6">
        ...
        <div className="mb-16">
            <div className="flex justify-between items-end mb-2">
                <span className="text-sm font-black text-primary">{Math.round(progress)}% <span className="text-slate/30 font-bold ml-1">Analyzing...</span></span>
                <span className="text-[10px] font-bold text-slate/30">{currentStep + 1} / {QUESTIONS.length + 1}</span>
            </div>
            ...
            >
                {currentStep < QUESTIONS.length ? (
                    <div className="space-y-10">
                        <div className="space-y-4">
                            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-mist text-slate/60 text-[10px] font-black uppercase tracking-widest">
                                {currentQ.category}
                            </span>
                    ...
                    <div className="space-y-10">
                        ...
                        <Button 
                            ...
                            className="w-full h-20 bg-primary text-white rounded-[28px] font-black text-xl shadow-2xl shadow-primary/20"
                        >
